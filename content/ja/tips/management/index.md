...
日報管理アプリのNipoPlusでは、全ての日報は「日報保存箱」という場所にまとめて集約されます。
...
{{<btnCenter "/docs/manual/read-report/list/" "操作ガイド:日報保存箱">}}
...
ここでは「タグ」による検索を画像で紹介しましたが、他にもスタッフで絞り込んだり、使用されている日報テンプレートで絞り込むなど、様々な検索で目的の日報を素早く発見できます。  
...
スタッフがスマートフォンやタブレットから日報を書けばそれらは自動で保存箱に格納されますし、カレンダー上にも表示されます。
