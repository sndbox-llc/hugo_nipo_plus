...
{{<appscreen filename="report-delete" title="日報の削除" desc="自分の日報でかつ状態が新規のため削除可能。削除ボタンが表示される" >}}
...
{{<appscreen filename="back" title="日報削除後の画面" desc="日報が削除されたため表示中の日報が読み込みエラーとなる。戻るボタンをクリックして一覧へ戻ります" >}}
