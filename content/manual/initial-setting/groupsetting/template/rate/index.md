...
より大きな数値を入力したい場合は[スライド入力フォーム](/manual/initial-setting/groupsetting/template/step/)か、[数値入力フォーム](/manual/initial-setting/groupsetting/template/math/)の利用を検討してください。
...
CSV出力は複数の日報やチェックシートを[まとめてCSV出力する](/manual/report/analytics/csv/)方法と、[1つの日報だけをCSV出力](/manual/report/read/csv/)する方法があります。詳細な手順は各ページを参照してください。
