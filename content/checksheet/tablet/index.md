...
この5Sチェックシートは[レート入力フォーム](/manual/initial-setting/template/rate/)と[選択式入力フォーム](/manual/initial-setting/template/select/)の2種類（各3個づつ、計6個）を組み合わせて構成されています。
...
こちらのチェックシートでも軸ブレ幅の項目で[選択式入力フォーム](/manual/initial-setting/template/select/)が使用されています。その他に製品保証Aの項目では[チェックボックス式入力フォーム](/manual/initial-setting/template/checkbox/)が使用され、重量の項目では[スライダー式入力フォーム](/manual/initial-setting/template/step/)が使用されています。
