...
{{<appscreen filename="report-destination" title="日報の提出先と共有先について" desc="提出先のアカウントはその日報を承認できます。共有先のアカウントは日報を読むことはできますが承認はできません" >}}
...
{{<appscreen filename="approval-report" title="提出先に指定されたアカウントで日報を開いた例" desc="提出先に指定されたスタッフの画面からみた日報画面。承認や棄却ボタンが配置されていることが確認できます" >}}
...
{{<appscreen filename="report-progression" title="承認のリレー開始" desc="最初の承認者が承認を押したところ。承認権限が二人目に譲渡され自身は共有先となる。そのため承認後の取り消し操作はできません" >}}
