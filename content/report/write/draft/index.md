...
{{<imgproc report-draft-save.png "日報やチェックシートを作成する際に、「下書き」にチェックを入れて保存すると下書きBOXに保存されます" />}}
...
{{<imgproc report-draft-box.png "下書きBOXから清書したいデータを選んでください。クリックすると日報作成画面に切り替わります" />}}
...
{{<imgproc draft-delete.png "不要になった下書きの日報は下書きBOXから直接削除します" />}}
