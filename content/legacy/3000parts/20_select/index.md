...
{{< callout context="tip" title="[後続のNipoPlusでも利用可能](/docs/template/selects/#plain)です" icon="outline/note" />}}
...
{{< callout context="tip" title="[後続のNipoPlusでも利用可能](/docs/template/selects/#multiple)です" icon="outline/note" />}}
