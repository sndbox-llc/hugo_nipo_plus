...
|本文検索|日報やチェックシートに含まれている文字列で検索ができます。[数値入力フォーム](/manual/initial-setting/group-setting/template/math/)や[レート入力フォーム](/manual/initial-setting/group-setting/template/rate/)などの「計算可能な数値」データは本文検索で検索できません|
