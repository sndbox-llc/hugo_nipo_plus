...
[無料プラン](/docs/price/free/)はいくつかの機能制限がかかりますが、日報の作成や承認といった基本的な機能は利用が可能です。
...
スタッフが全員自分たちのスマートフォンから[日報を書く](/docs/manual/write-report/write/)場合は、使用する端末数＝スタッフの人数となるため、スタッフ人数分のお申し込みをお願いします。
...
<dt><div>日報の提出ボタンが押せなくなりました</div></dt>
