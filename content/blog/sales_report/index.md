...
今回の例では８件の営業日報を1枚のエクセルにまとめていますが、バラバラの日報を1枚のエクセルにまとめるのは本当にたった数クリックで行うことができます。
...
１列追加されたら、その列の2行目にカーソルを持ってきて、次のような式を入力します
...
1. キーボードから「-」と打つ
1. ２つ左隣のセルをクリックする(またはカーソルキーの左矢印を2回押す)
1. エンターを押下
...
今私達は経過時間の計算をしているのでわかりますが、他の人が見た時これを「３時30分」と読み間違えてしまう可能性があります。
