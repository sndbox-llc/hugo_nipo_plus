...
|名称|説明|
|---|---|
|[日報にコメントが追加](/manual/read-report/comment/)されたとき|日報の作成者に対して通知を発行|
|タスクにコメントが追加されたとき|タスクの担当者に対して通知を発行（複数の場合は全担当者）|
|日報が作成されたとき|日報の提出先に指定されたスタッフに対して通知を発行|
|[日報を既読](/manual/read-report/state/)にしたとき|日報の作成者に対して通知を発行|
|[日報が承認されたとき](/manual/read-report/state/)|日報の作成者に対して通知を発行  次の承認者がいる場合は次の承認者に日報提出の旨の通知も併せて発行|
|日報が棄却されたとき|日報の作成者に対して通知を発行|
|[日報にタグがセット](/manual/read-report/other/)されたとき|日報の作成者に対して通知を発行|
