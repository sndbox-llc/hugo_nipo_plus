+++
archetype = "home"
description = "テンプレートを自分たちで自由に設計可能。蓄積した日報を集計・グラフ化できます。もちろんモバイル対応。料金も最安値クラスです"
menuTitle = "Home"
title = "1名180円 クラウド日報アプリ"
toc = false
tags = []
reqMermaid = false
+++
...
日報と銘打っていますが**チェックシートもテンプレートに沿って記入する**点で本質的に同じであるため、チェックシートアプリとしても利用できます。
