...
{{<appscreen filename="use-directory" msg="フォルダ機能の有効化はワンクリックで完了です。ONにするとフォルダ作成やツリー表示ボタンなど様々な機能が表示されるようになります">}}
...
{{<appscreen filename="make-directory" msg="フォルダの新規作成。現在の作業フォルダ内に新規に追加されます">}}
...
{{<appscreen filename="move" msg="テンプレートを指定したフォルダへ移動する">}}
...
{{<appscreen filename="move-batch" msg="移動させるテンプレートを選び、まとめて移動が可能です">}}
...
{{<appscreen filename="directory-setting" msg="フォルダの編集や削除はメニューボタンをクリックして表示します">}}
...
{{<appscreen filename="tree-view" msg="ツリー表示">}}
