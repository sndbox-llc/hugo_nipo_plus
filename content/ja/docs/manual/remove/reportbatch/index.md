+++
description = "管理者の権限でレポートを纏めて削除できます。古くなったデータやセンシティブなデータを削除する際に便利です"
tags = ["データ削除", "要管理者権限"]
title = "レポートの一括削除"
toc = true
weight = 101011004
...
{{<appscreen filename="report-delete" title="一括削除では承認済みのレポートや進行中のレポートもお構いなしに削除できます。実行には編集者権限が必要です">}}
