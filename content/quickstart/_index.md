...
{{<imgproc main.png "規約同意後に表示される画面。組織の全体設定画面です。あなたのアカウントと１つのグループが作成されていることが確認できます" />}}
...
「今日のラッキーカラー」とかよくわからない日報だな？と思いましたか？この日報テンプレートはサンプルで用意されているもので、テンプレートの内容は自由にカスタマイズができます。

{{<alice pos="right" icon="ok">}}
詳しくは[日報テンプレート](/org/groupsetting/template/)のカスタマイズについてを御覧ください
{{</alice>}}
