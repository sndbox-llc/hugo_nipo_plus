...
{{<appscreen filename="file-template-edit" title="日報テンプレートの編集画面" desc="日報にPDF等のファイルを添付するフォームを追加します" >}}
...
{{<appscreen filename="input" title="ファイル添付" desc="ファイル入力フォームを使った日報の作成画面イメージ。添付したファイルは即座にアップロードされます。" >}}
...
{{<appscreen filename="post" title="日報に添付されたファイルのダウンロード" desc="添付されたファイルはクリックしてローカルにダウンロードして使用できます。" >}}
