+++
description = "業務日報や作業報告書、品質シートなど様々な日報テンプレートを集めました。用途に応じて自由にカスタマイズして利用できます"
menuTitle = "日報テンプレート"
tags = []
title = "業務日報テンプレート集"
toc = true
...
{{<appscreen filename="sample1" title="業務日報テンプレートサンプル1" desc="業務日報テンプレートサンプル1" >}}
...
{{<appscreen filename="sample2" title="時間毎に書くタイプの業務日報テンプレート1" desc="時間毎に書くタイプの業務日報テンプレート1" >}}
...
{{<appscreen filename="sample11" title="時間毎に書くタイプの業務日報テンプレート2" desc="時間毎に書くタイプの業務日報テンプレート2" >}}
...
{{<appscreen filename="sample3" title="マイクロ日報テンプレート" desc="マイクロ日報テンプレート" >}}
...
{{<appscreen filename="sample4" title="現地調査報告書のテンプレート" desc="現地調査報告書のテンプレート" >}}
...
{{<appscreen filename="sample5" title="設備点検チェックシートのテンプレート" desc="設備点検チェックシートのテンプレート" >}}

少し回りくどく感じるのであれば、設問を1つの入力フォームにまとめてしまうこともできます。
それだと説明を記入する欄が無くなるので、別途テキスト入力フォームを追加しています。
上の点検チェックシートに比べてだいぶシンプルに纏まっていることがわかります。

{{<appscreen filename="sample6" title="設備点検チェックシートのテンプレート（簡易版）" desc="設備点検チェックシートのテンプレート（簡易版）" >}}
...
{{<appscreen filename="sample7" title="設問が多いチェックシートを分割する例" desc="設問が多いチェックシートを分割する例" >}}
...
{{<appscreen filename="sample8" title="製品品質チェックシートのテンプレート" desc="製品品質チェックシートのテンプレート" >}}

## タクシードライバー向けの報告書

タクシーや運転代行などで日報を書く場合は、例えば次のようなタクシー日報のテンプレートになります。

{{<appscreen filename="sample9" title="タクシー日報のテンプレート" desc="タクシー日報のテンプレート" >}}
...
{{<appscreen filename="sample10" title="署名欄ありの完了報告書テンプレート" desc="署名欄ありの完了報告書テンプレート" >}}
...
{{<button "/org/groupsetting/template/" "テンプレートの作り方">}}
