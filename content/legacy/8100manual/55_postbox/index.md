...
{{<figure src="post1.png"  alt="日報一覧表示。絞り込みや検索が行えます" caption="日報一覧表示。絞り込みや検索が行えます" >}}
...
{{<figure src="post5.png"  alt="日報カード詳細" caption="日報カード詳細" >}}
...
{{<figure src="post2.png"  alt="タグを使い日報を絞り込んだ例" caption="タグを使い日報を絞り込んだ例" >}}
...
{{<figure src="post3.png"  alt="全文検索によって日報を検索した例" caption="全文検索によって日報を検索した例" >}}
...
{{<figure src="post4.png"  alt="日報の詳細表示" caption="日報の詳細表示" >}}
...
{{<figure src="post6.png"  alt="日報のIDやサーバ保存時間などの詳細情報" caption="日報のIDやサーバ保存時間などの詳細情報" >}}
