...
#### 【NipoPlus】2023/06/10 Version 1.41.0{#vp1.41.0}
...
#### 【NipoPlus】2023/05/06 Version 1.38.2{#vp1.38.2}
...
#### 【NipoPlus】2023/04/26 Version 1.38.1{#vp1.38.1}


- カード決済画面のページ移動先が誤っていましたので修正しました。（決済自体は正しく動作していますのでご安心ください）

#### 【NipoPlus】2023/04/23 Version 1.38.0{#vp1.38.0}
...
#### 【NipoPlus】 2023/04/17 Version 1.37.1{#vp1.37.1}
...
#### 【NipoPlus】 2023/04/07 Version 1.36.0{#vp1.36.0}
...
#### 【NipoPlus】 2023/04/02 Version 1.35.0{#vp1.35.0}
...
#### 【NipoPlus】 2023/03/24 Version 1.34.1{#vp1.34.1}
...
#### 【NipoPlus】 2023/03/18 Version 1.33.0{#vp1.33.0}
...
#### 【NipoPlus】 2023/03/15 Version 1.32.1{#vp1.32.0}


- これまでWeb版からしか出来なかったアカウントの新規作成がiOS/Android上からも利用できるようになりました

#### 【NipoPlus】 2023/03/14 Version 1.32.0{#vp1.32.0}
...
#### 【NipoPlus】 2023/02/27 Version 1.31.1{#vp1.31.1}

- [受信BOX](/docs/manual/read-report/list/)で初期の表示期間を3日・1週間・2週間から選べるようになりました
- 組織設定の画面周りを微調整しました

#### 【NipoPlus】 2023/02/24 Version 1.31.0{#vp1.31.0}
...
#### 【NipoPlus】 2023/02/21 Version 1.30.0{#vp1.30.0}
...
#### 【NipoPlus】 2023/02/19 Version 1.29.1{#vp1.29.1}

- WebサイトのマニュアルURLが一部変更になり、それに合わせてリンク先を修正しました

#### 【NipoPlus】 2023/02/11 Version 1.29.0{#vp1.29.0}

- テンプレートコピー時に提出先情報も含めてコピーされるように機能を変更しました（リクエスト）

#### 【NipoPlus】 2023/02/10 Version 1.28.0{#vp1.28.0}

- 異なるテンプレート間の集計を行える機能（[クロス集計](/docs/manual/analytics/cross/)と命名）を実装しました

#### 【NipoPlus】 2023/02/04 サーバサイド更新{#server20230204}

- 日報をPDFに出力する際、曜日をあわせて出力するように修正しました

※アプリの更新はありません

#### 【NipoPlus】 2023/01/28 Version 1.27.0{#vp1.27.0}
...
#### 【NipoPlus】 2023/01/23 Version 1.26.0{#vp1.26.0}
...
#### 【NipoPlus】 2022/12/23 Version 1.24.0{#vp1.24.0}
...
#### 【NipoPlus】 2022/12/17 Version 1.23.1{#vp1.23.1}

- カレンダーが「月間」モードではじまるとき、正しい期間の取得がされないバグを修正しました
- 日報テンプレートの作成画面を一部変更しました

#### 【NipoPlus】 2022/12/14 Version 1.23.0{#vp1.23.0}
...
#### 
#### 【NipoPlus】 2022/12/10 Version 1.21.2{#vp1.21.2}
...
#### 
#### 【NipoPlus】 2022/12/09 Version 1.21.1{#vp1.21.1}
...
#### 【NipoPlus】 2022/12/08 Version 1.21.0{#vp1.21.0}
...
#### 【NipoPlus】 2022/12/02 Version 1.20.0{#vp1.20.0}


- [グラフ作成機能](/docs/manual/analytics/chart/)が実装されました

#### 【NipoPlus】 2022/11/07 Version 1.19.0{#vp1.19.0}
...
#### 【NipoPlus】 2022/10/25 Version 1.18.0{#vp1.18.0}

- 日報テンプレートの編集画面で各入力フォームに説明用の画像を添付できるようになりました
- PDF単体出力ボタンを独立させました

#### 【NipoPlus】 2022/10/21 version 1.17.0{#vp1.17.0}
...
#### 【NipoPlus】 2022/10/15 Version 1.16.0{#vp1.16.0}

- CSV出力時、各項目ごとに列の展開ON/OFFの指定ができるようになりました
- 日報テンプレート作成画面を使いやすく修正しました
- 在庫管理機能を一部拡張しました

#### 【NipoPlus】 2022/10/03 Version1.15.0{#vp1.15.0}

- 期間入力で休憩時間の入力ができるようになりました
- 過去データ推移で1に関する表示を修正しました
- 日報データのヘッダーエリアを非表示にできるようになりました

#### 【NipoPlus】 2022/10/01 Version1.14.0{#vp1.14.0}

- 受信BOXで日報をポップアップ表示出来るようになりました

#### 【NipoPlus】 2022/09/14 version 1.13.1{#vp1.13.1}
...
#### 【NipoPlus】 2022/09/13 Version 1.13.0{#vp1.13.0}
...
#### 【NipoPlus】 2022/08/31 v1.12.1{#vp1.12.1}
...
#### 【NipoPlus】 2022/08/29 Version 1.12.0{#vp1.12.0}
...
#### 【NipoPlus】 2022/08/21 Version 1.11.0{#vp1.11.0}
...
#### 【NipoPlus】 2022/07/01 Version 1.5.1{#vp1.5.1}
...
#### 【NipoPlus】 2022/06/13 Version 1.2.2{#vp1.2.2}
...
#### 【NipoPlus】 2022/06/10 Version 1.2.0{#vp1.2.0}

- [日報テンプレート](/docs/manual/initial-setting/template/_about/)のラベルを色分けできる機能が追加されました

#### 【NipoPlus】 2022/06/08 Version 1.1.0{#vp1.1.0}

- CSV出力に「縦列入れ替えオプション」が追加されました

#### 【NipoPlus】 2022/05/30 Version 1.0.2{#vp1.0.2}

- Android版・iOS版・Web版が出揃いました

#### 【NipoPlus】 2022/05/08 Version 0.2.9{#vp0.2.9}

- RC版

#### 【NipoPlus】 2022/04/22 Version 0.0.1{#vp0.0.1}
