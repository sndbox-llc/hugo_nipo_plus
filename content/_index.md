...
## 自分たちでカスタマイズ可能な業務報告システムです

nipoplusは簡単な操作でオリジナルのテンプレートを作成できるクラウド型のWebアプリケーションです。
例えば以下のようなお悩みはありませんか？

<div style="border: 5px solid #CCC; padding: 10px;margin: 40px 0">

- 日報やチェックシートなど「雛形」を使った報告書の入力がしたい
- 報告書のデータを効率よく集計し、データの可視化を行いたい
- できるだけ費用を抑えてシステムを使いたい
