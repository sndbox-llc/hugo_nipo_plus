...
より大きな画面で提出状況を確認したい場合は[カレンダー機能](/docs/manual/calendar/)をご利用ください。
...
より詳しいガイドは[CSV出力（一括）](/docs/manual/analytics/csv/)を御覧ください
...
|本文検索|日報やチェックシートに含まれている文字列で検索ができます。[数値入力フォーム](/docs/manual/initial-setting/template/math/)や[レート入力フォーム](/docs/manual/initial-setting/template/rate/)などの「計算可能な数値」データは本文検索で検索できません|
...
さて、ここまでは日報一覧の操作について見てきました。1件1件の日報を詳細に見るガイドは[「日報の詳細ビュー」のページ](/docs/manual/read-report/_about/)にあります。
