...
{{<appscreen filename="table-make" title="クロス集計の新規作成" desc="集計画面から設定" >}}
...
{{<appscreen filename="table-edit" title="行と列とセルをそれぞれ設定する" desc="行と列とセルをそれぞれ設定する" >}}
...
{{<appscreen filename="calc-field" title="計算列の追加" desc="計算列の追加" >}}
...
{{<appscreen filename="previews" title="プレビュー" desc="プレビュー" >}}
...
{{<appscreen filename="view" title="作成したクロス集計を表示する" desc="作成したクロス集計を表示する" >}}
