...
{{<imgproc calc.png Resize "1200x" "チェックシートのデータを集計するまでの手順" />}}
...
{{<imgproc stack.png Resize "1200x" "累積は各列にスタッフ、各行に入力項目を取った表です。スタッフごとのデータを比較する際に有益です" />}}
...
{{<imgproc sumfilter.png Resize "1200x" "絞り込み集計は少し特殊な用途に限定される集計機能です。" />}}
...
{{<imgproc charts.png Resize "1200x" "チェックシートのデータ推移を確認するための集計機能。同じ日のデータを纏める機能もあります" />}}
