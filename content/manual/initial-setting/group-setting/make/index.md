...
グループは組織内に何個でも作成できる作業場です。[日報の作成](/manual/write-report/)や[集計](/manual/analytics/)など日常業務の全てはグループの中で行われます。  
...
不要になった[グループは手軽に削除](/manual/remove/group/)できます。削除時にグループ内の[日報](/manual/read-report/list/)や[コメントデータ](/manual/read-report/comment/)は完全に抹消されるため、安全性も高く保てます。
