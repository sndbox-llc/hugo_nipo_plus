...
日報と組み合わせるには[商品入力フォーム](/manual/initial-setting/groupsetting/template/mod/)を日報テンプレートに追加してください。
...
登録した商品の状態を変化させたり、在庫数の増減をさせるには伝票を発行します。この「伝票」は日報テンプレートから「[商品入力フォーム](/manual/initial-setting/groupsetting/template/mod/)」を追加することで、
