...
{{<button "/manual/initial-setting/group-setting/template/" "この機能は後続のNipoPlusでもサポートされています">}}
...
[選択肢](/old/parts/select/)などのように設定項目が多い部品で使うと便利です。選択肢を追加した状態でコピーすると、選択肢も含めてコピーされます。
