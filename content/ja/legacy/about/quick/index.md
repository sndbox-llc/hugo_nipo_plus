...
isNipo = true
tags = ["旧バージョン"]
aliases = ["/old/manual/quick/", "/docs/old/manual/quick/", "/docs/old/quick/"]
[sitemap]
  changefreq = "yearly"
  priority = 0.2
+++
...
### Nipoを起動してアカウントを作成する{#make_account}
...
[メールアドレスを確認手順について](/docs/old/manual/email-verify/)  
...
[グループモードについて詳しくはこちら](/docs/old/manual/group-mode/)
...
日報テンプレートの編集について詳しくは[日報テンプレートの編集](/docs/old/manual/template/)を御覧ください
