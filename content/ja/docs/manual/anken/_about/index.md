...
{{<appscreen filename="anken-add" msg="案件を追加する">}}
...
{{<appscreen filename="set-anken" msg="レポート作成時に案件をレポートに紐づけします">}}
...
{{<appscreen filename="read-report-anken" msg="案件に紐づけされたレポートを表示した画面の例。通常のレポートとほとんど変わりませんが、ヘッダー右側に紐づけされた案件名が記載される点が違います">}}
...
{{<appscreen filename="anken-list" msg="案件一覧表">}}
...
{{<appscreen filename="anken-detail" msg="案件の詳細">}}
