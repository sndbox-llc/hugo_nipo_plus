...
aliases = ["/legacy/manual/edit-report/"]
title = "日報受信ボックスについて"
menuTitle = "日報を読む・編集・削除する"
...
{{< callout context="tip" title="[後続のNipoPlusでも利用可能](/docs/manual/read-report/list/)です" icon="outline/note" />}}
...
{{<figure src="img/post5.png"  alt="日報カード詳細" caption="日報カード詳細" >}}
...
{{<figure src="img/post2.png"  alt="タグを使い日報を絞り込んだ例" caption="タグを使い日報を絞り込んだ例" >}}
...
{{<figure src="img/post3.png"  alt="全文検索によって日報を検索した例" caption="全文検索によって日報を検索した例" >}}
...
{{<figure src="img/post4.png"  alt="日報の詳細表示" caption="日報の詳細表示" >}}
