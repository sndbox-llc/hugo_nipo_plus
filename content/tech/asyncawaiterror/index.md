...
{{<imgproc console_log.png "async・awaitでエラー時に処理が止まらない" />}}
...
{{<imgproc console_log2.png "async関数の呼び出し元で正しくエラーをキャッチできた" />}}
...
{{<imgproc over_lap_error.png "errorオブジェクトをnewErrorで包むと扱いにくくなる" />}}
...
{{<imgproc finally.png "inally句が正常に実行されていることが確認できる" />}}
