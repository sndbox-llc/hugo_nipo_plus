...
isNipo = true
tags = ["旧バージョン"]
aliases = ["/old/manual/timecards/", "/docs/old/manual/timecards/"]
[sitemap]
  changefreq = "yearly"
  priority = 0.2
+++
...
タイムカードを日報に埋め込むには、[タイムカードパーツ](/docs/old/parts/timecard/)を[日報テンプレートに追加](/docs/old/manual/template/)することで実現できます。  
...
詳しくは[料金プランのページ](/docs/old/system/price/)を御覧ください
