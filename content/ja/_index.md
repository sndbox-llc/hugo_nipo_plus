...
誰でも簡単にオリジナルの入力フォームを作成できます。多目的対応の入力パーツ（文字入力、数字入力、画像入力など）を組み合わせるだけで、自社に最適なテンプレートを作成できます。これにより、特別な技術知識がなくても、自社の業務に合った入力フォームを迅速に構築できます。
...
### テンプレートに沿って日報を書くだけ。PC初心者が躓く「上書き保存」や保存場所も一切でてきません
...
{{<btnFull "/tips/required/" "記入漏れ・手順飛ばしを防ぐ">}}
