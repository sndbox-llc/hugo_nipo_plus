...
{{<icatch filename="reportbox" msg="日報は全て同じ場所 振り分けが不要です" title="日報は一箇所に集約されるため、フォルダ分けやファイル名の管理が一切不要です。" fontsize="30px" alice="ok">}}
...
{{<icatch filename="date-range" msg="日付の範囲を選んで 日報を簡単に発見" title="日付を選ぶだけで条件に合致する日報のみを瞬時に表示します。効率よく目的の日報を探せます" fontsize="30px" alice="book">}}
...
{{<icatch filename="tag-filter" msg="タグによる日報の 絞り込み検索機能" title="タグによる日報の絞り込み。タグの種類は自由に追加削除できます。日報をカテゴライズしたり、目印として使ったり、検索に使ったり様々な活用ができます。" fontsize="30px" alice="here">}}
...
{{<icatch filename="calendar" msg="日報をカレンダー上 に配置する表示モード" title="カレンダー上に日報を並べて表示します。日別に日報を見たいときに便利な機能です" fontsize="30px" alice="guide">}}
...
{{<appscreen filename="agenda" msg="日報をカレンダー上 に配置する表示モード" title="スタッフごとに分けたカレンダー表示。スタッフの提出漏れも瞬時に判別可能" fontsize="30px" alice="guide">}}
