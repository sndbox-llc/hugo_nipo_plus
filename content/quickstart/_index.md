...
{{<appscreen filename="main" title="管理画面" desc="規約同意後に表示される画面。組織の全体設定画面です。あなたのアカウントと1つのグループが作成されていることが確認できます" >}}
...
{{<appscreen filename="write-report" title="日報作成画面" desc="初めての日報作成。テンプレートに添って記入を行い、提出先を指定します。最後に提出ボタンをクリックするとその日報は提出者に対して送信されます" >}}
...
{{<appscreen filename="writed-report" title="日報提出後の画面" desc="日報を提出後のアクション。続けて書くか、テンプレートを変更するか、書いた日報を確認する" >}}
...
{{<appscreen filename="read-report" title="日報を読み、承認する" desc="さきほど提出した日報の詳細表示画面。承認や棄却、PDF出力などが行なえます" >}}
...
{{<appscreen filename="promotion-account" title="匿名アカウントを正規アカウントに昇格させる" desc="匿名アカウントを正規アカウントへ昇格させるにはE-mailとパスワードをセットする必要があります。なおNipoPlus上にすでに登録されているメールアドレスは利用できません" >}}

{{<imgproc promotion-account.png "" />}}
