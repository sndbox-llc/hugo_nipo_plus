...
グループのモードを切り替えるには管理者、またはマネージャの権限が必要です。スタッフの権限については[スタッフ管理](/docs/old/manual/staff-manage/)を参照してください
...
詳しくは[日報を書く](/docs/old/manual/write-report/)を御覧ください。
...
この設定はスタッフ単位で指定できます。詳しくは[スタッフ管理](/docs/old/manual/staff-manage/)を御覧ください
