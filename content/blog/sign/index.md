...
NipoPlusでは[署名入力フォーム](/manual/initial-setting/groupsetting/template/sign/)を報告書のテンプレートに追加することで、簡単に手書きの署名を報告書内に埋め込むことが可能です。
...
署名データは[PDFエクスポート](/manual/report/read/pdf/)時に適切に埋め込んで表示されます。
...
NipoPlusでは報告書のデータを[CSVに出力する](/manual/report/read/csv/)機能がありますが、残念ながら署名入力フォームはCSVに出力できません。
