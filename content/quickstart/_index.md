...
{{<button "/manual/initial-setting/staff/" "スタッフの権限について">}}
...
{{<button "/manual/notice/email/" "メール通知について">}}
...
{{<button "/manual/initial-setting/advanced-setting/dist/" "日報提出先の固定化">}}

今回の例では登場していませんが、日報テンプレートには集計が可能な入力フォームもあります。日報から集計可能なデータだけを抜き出して比較したり、グラフを作成することも可能です。

{{<button "/manual/analytics/" "日報データの集計・グラフ化">}}
