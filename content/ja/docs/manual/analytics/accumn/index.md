...
{{<appscreen filename="acc-table" msg="レポートを提出したスタッフごとに分けて集計可能。スタッフ同士の比較に最適">}}
...
{{<appscreen filename="acc-table2" msg="集計機能を使いレポートを集計した結果">}}
...
{{<appscreen filename="make-fomula" msg="集計表に数式を追加して計算行を付け足す">}}
...
{{<appscreen filename="charts" msg="累積表のデータを元に棒グラフを作成">}}
