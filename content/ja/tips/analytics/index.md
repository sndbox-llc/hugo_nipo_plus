...
{{<appscreen filename="make-receipt" msg="部品の生産個数を入力するだけの伝票のような日報。もはや伝票と表現したほうが適切である">}}
...
{{<appscreen filename="cross" msg="クロス集計を使うことで複数のチェックシートテンプレートを1つの表にまとめて集計できます">}}
