...
合同会社サンドボックスでは様々なWebAppを開発していますが、その多くは先人たちの築き上げてきたオープンソースを利用させて頂いております。
...
この女の子は[イラストレータ「ふにぐみ」さま](https://www.ac-illust.com/main/profile.php?id=0DbjwSb1)に書いていただきました。
ありがとうございます
{{</alice>}}
