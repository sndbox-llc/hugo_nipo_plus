...
toc = true
weight = 320
aliases = ['/org/groupsetting/template/rate/']
+++
...
より大きな数値を入力したい場合は[スライド入力フォーム](/manual/initial-setting/group-setting/template/step/)か、[数値入力フォーム](/manual/initial-setting/group-setting/template/math/)の利用を検討してください。
