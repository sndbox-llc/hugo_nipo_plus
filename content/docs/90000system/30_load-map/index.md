...
| 登録日     | カテゴリ | 内容                                                                                                            | 顛末                                            |
| ---------- | -------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| 2025/12/16 | バグ     | クレジットカードを変更すると初回支払い時に3DS認証が発生して決済が失敗するバグの修正                             |                                                 |
| 2025/12/16 | バグ     | CSV出力 休憩時間が出力されないバグ                                                                              |                                                 |
| 2025/12/10 | バグ     | PDF出力「一括出力に追加」を使うと検印欄が設定にかかわらず出力されてしまうバグの修正                             |                                                 |
| 2025/11/17 | 要望     | 集計・複数人承認の日報がある場合、まだ承認順が来ていなくても集計できるようにする                                |                                                 |
| 2025/11/8  | 要望     | 顧客メモでも外部共有リンク機能を追加する                                                                        |                                                 |
| 2025/11/7  | バグ     | 集計・CSV出力でデータが500件までしか取得できない制限の変更                                                      |                                                 |
| 2025/10/24 | 要望     | 送信受信BOX　起動時に直近１ヶ月の表示設定を追加する                                                             |                                                 |
| 2025/10/24 | 要望     | 送信BOXにも検索条件の保存を実装する                                                                             |                                                 |
| 2025/10/17 | バグ     | 顧客メモ 保存した検索条件が削除できない                                                                         | [1.74.2](/docs/system/release-note/#vp1_74_2)   |
| 2025/10/14 | 要望     | 顧客メモ 予定ステータスのものを予定日時刻基準でソートする仕組み                                                 |                                                 |
| 2025/10/14 | 要望     | 検索条件保存で「表示形式」も合わせて記憶する                                                                    |                                                 |
| 2025/10/07 | 要望     | 顧客対応メモ 予定として登録の他に「完了として登録」等も追加してほしい                                           |                                                 |
| 2025/10/05 | 要望     | コメント欄のサイズを大きくしてほしい                                                                            | [1.74.0](/docs/system/release-note/#vp1_74_0)   |
| 2025/10/03 | 要望     | あとから日報の閲覧可能な人を変更できるようにする（過去の日報修正）                                              |                                                 |
| 2025/9/25  | 要望     | 顧客管理：プロフィール写真をつけられるようにする                                                                | [1.74.0](/docs/system/release-note/#vp1_74_0)   |
...
| 2025/9/05  | 要望     | 日報検索条件に「既読済み」を追加する                                                                            | 済                                              |
| 2025/8/05  | 要望     | PDF一括出力：日付の基準を選択可能に                                                                             |                                                 |
| 2025/6/5   | 要望     | 反復入力の算術で縦合計を出す                                                                                    | [1.74.0](/docs/system/release-note/#vp1_74_0)   |
...
| 2024/12/27 | 要望     | 日報未提出者にメールを送る機能                                                                                  | 済                                              |
...
| 2024/02/07 | 要望     | 日報作成時に前回の内容を参照できる機能                                                                          | [1.74.0](/docs/system/release-note/#vp1_74_0)   |
| 2024/01/17 | バグ     | Nipo【旧版】で下書きから清書した日報のメールが届かないバグの修正                                                |
| 2023/11/22 | 要望     | スタッフごとにデータの推移をグラフで確認したい                                                                  |
...
| 2023/04/10 | 要望     | テンプレートの編集で「一覧」と「詳細」のページの行き来が不親切なので使い勝手を改善する                          | [1.38.0](/docs/system/release-note#vp1_38_0)    |
