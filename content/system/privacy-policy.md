...
NipoPlusのサービスを通じて作成された全ての情報（[日報テンプレート](/org/groupsetting/template/)や[コメント](/report/read/comment/)、自動で記録される[ログ](/org/group2/log/)などを含みます。以下「成果物」）はサーバのデータベースに保存されます。  
