...
{{<icatch filename="app" msg="NipoPlus実際の画面 一人承認した日報の例" title="NipoPlus画面イメージ" desc="NipoPlusのアプリ画面のイメージ図" fontsize="30px" alice="ok" >}}
...
{{<icatch filename="report-detail" msg="承認リレー/コメ ント・通知もあるよ" title="コメント機能・通知機能・承認リレー" desc="コメントでスタッフとのコミニケーションをとることや、複数スタッフによる日報の承認リレーも利用できます。" fontsize="30px" alice="please" >}}
