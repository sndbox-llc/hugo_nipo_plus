...
NipoPlusのサービスを通じて作成された全ての情報（[テンプレート](/docs/manual/initial-setting/template/make/)や[コメント](/docs/manual/read-report/comment/)、自動で記録される[ログ](/docs/manual/utils/log/)などを含みます。以下「成果物」）はサーバのデータベースに保存されます。  
