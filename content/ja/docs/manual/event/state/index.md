...
{{<appscreen filename="color-event" msg="予定を色分けして管理可能">}}
...
{{<appscreen filename="switch-event-state" msg="予定の状態はボタン１つで切り替えできます。">}}
...
{{<appscreen filename="event-color-type" msg="予定の状況に応じて色の濃淡が変化します。予定が「破棄」の場合は全て同じグレーになります">}}
