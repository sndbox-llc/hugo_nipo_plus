...
{{<appscreen filename="sosiki" msg="メニュー左から「組織設定」を選ぶ">}}

{{<nextArrow>}}

{{<appscreen filename="add_group" msg="「グループ設定」のセクションに移動し、新規追加をクリックしてグループを作成します">}}
...
{{<appscreen filename="assign-staff2" msg="グループに所属するスタッフを選択">}}
...
{{<appscreen filename="move-group" msg="作業グループの切替は簡単に行なえます">}}
