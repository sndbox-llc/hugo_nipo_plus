+++
description = "予定を効率的に管理し、確認する方法をマスターしましょう。この記事では、予定をスタッフ別、期間別に表示する方法、カード形式でシンプルに予定を表示するオプション、予定の表示期間のカスタマイズ方法、終日予定の特別な扱い、そしてカレンダー機能を用いた細かい表示制御の方法について詳しく解説します。さまざまな表示オプションを駆使して、予定を一目で把握し、日々のスケジュール管理をスムーズに行うためのガイドを提供します。"
tags = []
title = "👀予定を確認する"
toc = true
weight = 101008002
...
{{<appscreen filename="view-event-staff" msg="スタッフを軸にして予定を表示させる">}}
...
{{<appscreen filename="view-event-range" msg="期間を指定して予定を表示する">}}

## 予定をカードで表示する{#show_event_card}

視覚的な演出が不要であれば、シンプルにカードで予定を表示する機能もあります。

{{<appscreen filename="view-event-card" msg="シンプルに１つの予定を１枚のカードで表示するモード">}}
...
{{<appscreen filename="switch-show-span" msg="予定の表示期間を変更する">}}
...
{{<appscreen filename="long-event" msg="数日にまたがる長いイベントはヘッダーに表示されます">}}
...
{{<appscreen filename="task-calendar-filter" msg="担当者や予定の状況で絞り込みが可能。">}}
