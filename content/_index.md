...
heroText = "「うちの会社に合う日報システムがない…」と諦めていませんか？自社の業務に合わせた日報テンプレートを自由に作成。スマホやPCから簡単入力、データは自動で集計しCSV出力できます。<br>10年探していたアプリとお褒め頂いたこともある、安価で最強の日報アプリです"
heroLinks = [
...
{{<icatch filename="make-charts" msg="エクセル無しでもグラフが作れるし、CSV出力もできるよ" alice="pc"  marginLess="true">}}

</div>

CSV出力した例▼（※見やすくするため◯を⭕に脚色しています）
...
<div class="col-lg-9">
{{<figure src="lawprice.webp"  alt="アイキャッチ" caption="">}}
