...
{{<icatch filename="locked" msg="提出先を固定することでスタッフが誤って別のスタッフに提出してしまうミスを防止できます" fontsize="30px" alice="ok">}}
...
{{<icatch filename="tag" msg="レポートにタグを付けることで一覧表示時に目印とすることが可能です。またタグによる絞り込み検索も可能です"   fontsize="30px" alice="here">}}
...
{{<icatch filename="switch-group" msg="作業グループを複数作成可能です。目的に応じてグループを分けることで効率のよいレポート管理が可能になります"   fontsize="30px" alice="guide">}}
