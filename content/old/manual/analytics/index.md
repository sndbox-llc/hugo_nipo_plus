...
{{<imgproc sum1.png "集計対象となる日報の例。文字は集計できないが数値は集計できる" />}}
...
{{<imgproc sum3.png "集計した日報をCSVにダウンロードする" />}}
...
{{<imgproc sum7.png "1名のスタッフを対象に、データの推移をグラフ＆テーブルで詳細に表示します" />}}
...
{{<imgproc calendar4.png "月間カレンダー上に集計データを表示する" />}}

スタッフ毎カレンダーで集計を表示した例

{{<imgproc calendar5.png "スタッフ毎カレンダー上に集計データを表示する" />}}
...
{{<imgproc sum11.png "Excel2007の画面" />}}
{{<imgproc sum12.png "Excel2007の画面" />}}
{{<imgproc sum13.png "Excel2007の画面" />}}
