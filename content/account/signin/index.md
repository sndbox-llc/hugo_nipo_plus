...
{{<appscreen filename="signin" title="NipoPlusにログインする" desc="ログインにはEmailとパスワードを入力する必要があります" >}}
...
{{<appscreen filename="signout" title="NipoPlusからログアウトする" desc="ご利用中の端末からログアウトするにはアカウント＞ログアウトの順にクリックします。" >}}
