...
{{<imgproc template_sample.png "トラブルレポートと言う名のテンプレート" />}}
...
{{<imgproc template_category.png "テンプレートに分類をセットする" />}}
...
{{<imgproc template_import.png "他のグループのテンプレートをインポートする" />}}
...
テンプレートの編集はいつでも可能ですが、Nipoでは現在最新のテンプレートを元にレポートを表示する仕組みのため、**過去に作成された日報に影響を与える可能性がある**ことに留意して下さい。
