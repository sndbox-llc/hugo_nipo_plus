...
title = "エクセルで営業日報をスタッフごとに集計する"
menuTitle = "エクセルで営業日報をスタッフごとに集計する"
toc = true
tags = ["エクセル",  "集計"]
date = "2023-10-22"
draft = false
...
２人の営業日報を１枚のエクセルにまとめて、スタッフごとに集計したいとしましょう。  
スタッフは「アリス」と「ボブ」とします。以下のようなエクセル表が出来上がったとします。
...
## アリスの売上高とボブの売上高を分けて集計するにはSumif関数が便利
...
## SUMIF関数の数式をフィルコピーするときは絶対パスと相対パスを組み合わせると良い
...
## 日報データをエクセルへ転記する手間・集計期間の変更など弱点もある（ちょっと宣伝）
