...
{{<imgproc passwordreset.png Resize "1200x" "アカウント管理画面からログインパスワードリセットボタンをクリックします" />}}
...
{{<imgproc newpw.png Resize "1200x" "新しいパスワードの設定画面です。6文字以上のパスワードを設定してください。安全性を考慮すると10文字以上が望ましいです" />}}
...
{{<imgproc login.png Resize "1200x" "ログイン画面にもパスワードリセット用のボタンが配置されています。" />}}
