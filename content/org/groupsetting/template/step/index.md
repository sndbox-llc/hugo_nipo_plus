...
{{<imgproc eye-catch.png "スライダ入力フォームを含んだ日報テンプレートの画面" />}}
...
{{<imgproc slider-template-edit.png "スライダ入力フォームのみで構成された日報テンプレート" />}}
...
またスライダは集計可能な入力フォームのため、[過去データ推移](/report/analytics/list/)機能がOnになっていると過去のデータ比較が簡単に行なえます。
...
{{<imgproc line-charts.png "1名のスタッフを対象にとり、データの過去推移を時系列に閲覧可能です" />}}
