...
{{<appscreen filename="report-template-edit" title="日報テンプレートの編集" desc="日報テンプレートの作成画面イメージ。テキスト入力フォームのみを4つ配置したシンプルな構図。入力必須と色の変更も使っています" >}}
...
{{<appscreen filename="report-detail" title="テキストの日報を読む" desc="テキスト入力フォームを含んだ日報を受信したときの見え方" >}}
