...
|名称|説明|
|---|---|
|共用先|アカウントを借りる側。[ログイン不可能アカウント](/manual/initial-setting/staff/make/#ログイン不可能なスタッフアカウントの作成)で、共用元のアカウントを借りて日報を書きます。|
|共用元|アカウントを貸す側。[ログイン可能アカウント](/manual/initial-setting/staff/make/#ログイン可能なスタッフアカウントの作成)で共通PC上でログインしている|
