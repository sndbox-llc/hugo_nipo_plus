...
{{<button "/docs/old/manual/template/" "テンプレートの作成ガイドを見る">}}
...
{{<button "/docs/old/manual/write-report/" "日報作成について詳しく見る">}}
...
{{<button "/docs/old/manual/pdf/" "PDFについて">}}
...
{{<button "/docs/old/manual/analytics/" "日報の集計について">}}
...
{{<button "/docs/old/manual/calendar/" "カレンダーについて">}}
...
{{<button "/docs/old/manual/timecards/" "タイムカード">}}
...
{{<button "/docs/old/system/price/" "料金について">}}
