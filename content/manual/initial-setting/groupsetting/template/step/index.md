...
（来客者は[数値入力フォーム](/manual/initial-setting/groupsetting/template/math/)の利用を推奨）
...
またスライダは集計可能な入力フォームのため、[過去データ推移](/manual/report/analytics/list/)機能がOnになっていると過去のデータ比較や、それをもとにしたグラフの作成が簡単に行なえます。
