...
{{<imgproc signup.png "匿名アカウントはE-mailやパスワードの設定をせずに利用できるアカウントです。継続した利用には不向きですが手軽に体験する上では最も簡単なアカウント作成方法です" />}}
...
ここではチュートリアルのため深くは触れませんが、より詳しいガイドは[グループについて](/org/groupsetting/)を御覧ください。

{{<alice pos="right" icon="here">}}
クイックスタートガイドではこれ以上グループについて触れません。良くわからなくてもあまり気にしなくてOKです
{{</alice>}}
...
詳しくは[日報テンプレート](/org/groupsetting/template/)の自作についてを御覧ください
{{</alice>}}
...
お疲れ様でした。これで日報が作成されて管理者宛に提出されました。日報作成についてより詳しいガイドに付いては[日報を書く](/report/write/write/)のページを参照してください。
...
|[スタッフの日報提出先固定化](/org/groupsetting/dist/)|AさんはBさんへ日報を提出するといった制御が可能です。制御がないとスタッフは誰に対しても日報を提出できます。設定は任意ですが設定しておくことで無用な混乱を回避できます|
