...
グループ設定にある[レポートの共有モード](/docs/setup/setting-group/#reportShare)の設定により影響があります。
...
前もって[管理者が提出先や共有先を固定する](/docs/setup/staff-local/dist/)ことも可能です。できればこの設定をしておくことを**強く推奨**します。
...
[グループの基本設定](/docs/setup/make-group/)でレポートの共有が「共有する」に設定されているとすべてのスタッフがレポートを読めます。
