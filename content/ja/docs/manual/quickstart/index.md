...
{{<appscreen filename="temp-id" msg="匿名アカウントをつかうことで煩雑なアカウント作成をスキップし、手軽に体験することが可能です">}}
...
{{<appscreen filename="new-template" msg="テンプレートの新規作成">}}
...
{{<appscreen filename="make-template" msg="テンプレートの編集">}}
...
{{<appscreen filename="write-report2" msg="初めてのレポート作成。テンプレートに添って記入を行い、提出先を指定します。最後に提出ボタンをクリックするとそのレポートは提出者に対して送信されます">}}
...
{{<appscreen filename="next" msg="レポート提出後のアクション">}}
...
{{<appscreen filename="report-agree" msg="レポートを承認する">}}
...
{{<appscreen filename="create-account" msg="スタッフアカウントを作成する">}}
...
{{<appscreen filename="sign-in" msg="スタッフのアカウントでログインする">}}
...
{{<icatch filename="switch-group" msg="作業グループを複数作成可能です。目的に応じてグループを分けることで効率のよいレポート管理が可能になります"  alice="guide">}}
