...
{{<appscreen filename="shift-board" msg="シフト表の入力">}}
...
{{<appscreen filename="update-shift-board" msg="シフト表の更新">}}
...
{{<appscreen filename="report-list" msg="シフト表の内容がそのまま提出状況表にも反映されます">}}
