...
{{<appscreen filename="report-delete" msg="自分のレポートでかつ状態が新規のため削除可能。削除ボタンが表示される">}}
...
{{<appscreen filename="back" msg="レポートが削除されたため表示中のレポートが読み込みエラーとなる。戻るボタンをクリックして一覧へ戻ります">}}
...
{{<appscreen filename="report-delete-batch" msg="一括削除では承認済みのレポートや進行中のレポートもお構いなしに削除できます。実行には編集者権限が必要です">}}
...
{{<appscreen filename="search-save" msg="検索の条件を保存することで次回から同じ条件の検索をワンクリックで行なえます">}}
