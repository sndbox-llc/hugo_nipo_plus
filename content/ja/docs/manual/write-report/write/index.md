...
{{<appscreen filename="report-template-select" msg="「レポート作成」をクリックするとテンプレートの選択画面が表示されます。">}}
...
{{<appscreen filename="write-report" msg="選んだテンプレートをもとにレポート画面が表示。左はiPad・右はiPhoneで開いた例。見た目が違いますが項目は同じであることが確認できます。必要事項を記入してレポートを書き上げます">}}
...
{{<appscreen filename="writed-report" msg="レポート提出後に次の操作を選ぶ画面が表示されます">}}
...
{{<appscreen filename="recovery-report" msg="記入途中のデータが検知されると復元確認のメッセージが表示されます。">}}
