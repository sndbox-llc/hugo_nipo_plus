...
国語・算数・理科・英語・社会、合計5つの入力フォームがある日報です。この内上の３つは[数値入力フォーム](/docs/manual/initial-setting/template/math/)を使用し、下の2つは[スライダ入力フォーム](/docs/manual/initial-setting/template/step/)を使用していますがいづれもグラフ化可能です。
...
例えば[選択式入力フォーム](/docs/manual/initial-setting/template/select/)は一覧から1つを選んで回答する入力フォームですが、これは選ばれた回数を数えてグラフ化できます。
