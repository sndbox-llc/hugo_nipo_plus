...
{{<imgproc eye-catch.png "選択肢入力フォームを含んだ日報テンプレート" />}}
...
{{<imgproc word-color-coding.png "色分けの指定を行うことで選択肢の識別がしやすくなります。" />}}
...
{{<imgproc word-totaling.png "NipoPlusの集計機能を使ってチェックシートの選択肢データをスタッフごとに自動で集計します" />}}
