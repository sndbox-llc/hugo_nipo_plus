...
NipoPlusを起動します。Webアプリなのでブラウザの**リンクを開くだけで起動**します。  
ブラウザは[Google Chorme](https://www.google.com/intl/ja_jp/chrome/)を推奨していますが他のブラウザでも動作可能です。  
初期設定はスマートフォンでもできますが、画面が小さいためできれば**PCで操作**してください。  
...
ワンクリックで発行できる[匿名アカウント](/docs/manual/account/tokumei/)を使えば面倒なパスワードの設定やE-mailの入力を後回しにできるので**お試しに最適**です。  
...
スタッフアカウントを追加して、レポートを読む人と書く人を明確に区別しましょう。
