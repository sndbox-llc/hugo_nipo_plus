...
国語・算数・理科・英語・社会、合計5つの入力フォームがある日報です。この内上の３つは[数値入力フォーム](/manual/initial-setting/group-setting/template/math/)を使用し、下の2つは[スライダ入力フォーム](/manual/initial-setting/group-setting/template/step/)を使用していますがいづれもグラフ化可能です。
