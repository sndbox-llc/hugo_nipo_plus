...
{{<icatch filename="sample20"  msg="作業前・作業後の現場写真を作業報告書テンプレートに追加することで現場写真つきの報告書が簡単にスマートフォンやタブレットだけで作れます" fontsize="30px" alice="phone">}}
...
{{<icatch filename="touch" msg="タップやスワイプなどスマートフォンに適した操作性を生かして日報を書きましょう"  fontsize="30px" alice="here">}}
